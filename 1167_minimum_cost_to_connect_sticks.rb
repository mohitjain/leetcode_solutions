...
def connect_sticks(sticks)
  ...
  until min_heap.size == 1
    stick_1 = min_heap.pop
    stick_2 = min_heap.pop
    final_stick = stick_1 + stick_2
    cost = cost + final_stick
    min_heap.add final_stick
  end
  cost

end

p connect_sticks [2, 4, 3]
p connect_sticks [1, 8, 3, 5]
p connect_sticks [5]
